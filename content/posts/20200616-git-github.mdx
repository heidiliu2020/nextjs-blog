...
description: 瞭解 Git Workflow 的流程。
slug: git-github
author: Heidi Liu
tags:
  - GitHub
...
### 補充：如何在 GitHub 上同步 Fork 過來的 Repository
...
> 若要刪除舊有的 remote，可參考 [[Git 筆記] 如何移除 remote origin](https://andy6804tw.github.io/2019/01/04/git-remove-remote/)。
...
用途是「當發生某事的時候通知我」。例如：當有人 commit、有人 push 時通知我。
...
3. [Git 教學：如何 Push 上傳到 GitHub？](https://gitbook.tw/chapters/github/push-to-github.html)
