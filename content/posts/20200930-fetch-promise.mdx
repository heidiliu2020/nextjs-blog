...
description: 本篇為 Limedy「Fetch 與 Promise 補充系列」課程的學習筆記。
slug: fetch-promise
author: Heidi Liu
tags:
  - Front-End
...
3. 掛載 load callback：加載完成時會呼叫 reqListener 函式
4. 發起一個請求 `.send()`
...
- [ES6 入門之 Promise 物件](https://www.itread01.com/content/1570606323.html)
