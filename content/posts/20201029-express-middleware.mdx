...
description: 學習如何使用 Express 及其相關套件。
...
1. 在 index.js 引入 express-session 套件：
...
1. 在 index.js 引入 connect-flash 套件：
...
- [bodyParser 中间件的研究](https://segmentfault.com/a/1190000004407008)
