title: '[week 4] 網路基礎概論 - HTTP 協定、TCP/IP'
author: Heidi Liu
tags:
  - Front-End
  - HTTP
...
是 HTTP 用「3 位數字代碼」來表示回應狀態，通常以開頭的數字來進行區分。詳細可參考 [HTTP 狀態碼- 維基百科](https://zh.wikipedia.org/wiki/HTTP%E7%8A%B6%E6%80%81%E7%A0%81)：
