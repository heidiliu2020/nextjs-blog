...
description: 這篇文章主要是介紹 Bing Chat，和 ChatGPT Plus 同樣支援 GPT-4，卻能夠免費使用！
slug: ironman-2023-day-24
author: Heidi Liu
tags:
  - ironman2023
  - Qiita
...
> 原文連結：[えっ、まだ ChatGPT 使ってんの？ Bing は無料で GPT-4 使えますよ！ - Qiita](https://qiita.com/takao-takass/items/16a7052a4a0e857b7c90)
...
然而，要使用 ChatGPT 的 GPT-4，每月個需支付 3,000 日圓(※)。
...
在過去兩週中，我透過 Bing Chat 來編寫程式和進行研究。我的感想是，Bing Chat 能做到與 ChatGPT 的 GPT-4（每個月 3,000 日圓的方案）相同的事情。
