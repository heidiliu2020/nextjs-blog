...
description:這篇文章介紹如何善用 Google 搜尋，找到想要的答案。
slug: ironman-2023-day-3
author: Heidi Liu
tags:
  - ironman2023
  - Qiita
...
javascript: (function () {
  window.open(
    `https://www.google.co.jp/search?q=${decodeURIComponent('%s')} site:${
      location.origin
    }`
  );
})();
...
在 Service 或 Library 名稱後加上關鍵字 `vs`，會顯示相近的搜尋建議。內容包括自己尚不瞭解的技術，可以在評估技術時提供參考。
...
- [OSS ノススメ - Zenn](https://zenn.dev/dodonki1223/articles/6418df73713313)
