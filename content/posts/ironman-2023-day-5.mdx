...
description: 在被使用者厭惡的廣告當中，有一種叫做「滑動廣告」。
slug: ironman-2023-day-5
author: Heidi Liu
tags:
  - ironman2023
  - Qiita
...
_只有思慕昔（スムージー）的廣告，在上下滑動時會跳轉到廣告頁面。_

這明顯和*漫畫廣告的行為不同。*

_此外，我們還注意到，左右滑動時也不會造成畫面跳轉。_
...
Y.prototype.Ba = function (a) {
  ...
  if (!this.W && 0 != this.b.length) {
    ...
    b.U = !0;
    this.V
      ? ((b.pageX = a.e.touches[0].pageX), (b.G = a.e.touches[0].pageX))
      : ((b.pageX = a.e.pageX), (b.G = a.e.pageX));
    b.time = Date.now();
    b.A = 0;
    b.p = 0;
  }
...
Y.prototype.Aa = function (a) {
  if (!this.W && 0 != this.b.length) {
    ...
    var d = !1;
    0 == this.Ma
      ? ($(c, this.H * a, this.I * a, this.J * a, this.K * a, 0),
  ...
  if (!this.W && 0 != this.b.length) {
    ...
    b.U &&
      ...
      500 < a - this.ua &&
        50 > Math.abs(b.p) &&
        250 > a - b.time &&
        (this.dispatchEvent('tap'), this.dispatchEvent('tap-' + this.d)),
      (this.ua = a));
    b.U = !1;
    b.ea &&
      ((a = this.d),
      Math.abs(b.p) > this.Na &&
        (0 > b.p
          ? (a = this.d == this.b.length - 1 ? this.d : this.d + 1)
          : 0 < b.p && (a = 0 == this.d ? this.d : this.d - 1)),
      this.Q(a),
      (b.ea = !1));
  }
};
