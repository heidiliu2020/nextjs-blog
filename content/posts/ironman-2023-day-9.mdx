...
description: `README.md` 是 Repository 的門面。通過編輯這份文件，能夠大幅提升 Repository 的質量。
slug: ironman-2023-day-9
author: Heidi Liu
tags:
  - ironman2023
  - Qiita
...
> 原文連結：[イケてるレポジトリの README.md には何を書くべきか - Qiita](https://qiita.com/autotaker1984/items/bce70c8c67a8f6fb1b9d)
